...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.calendario-box .days li[data-date]').forEach(dia => {
    dia.addEventListener('click', () => {
      dataSelecionada = dia.getAttribute('data-date');
      console.log('Data selecionada:', dataSelecionada);
      abrirModal('modal_promocao/bloqueio');
    });
  });
  ...
  if (btnBloquear) {
    btnBloquear.addEventListener('click', () => {
      ...
      form.querySelector('[name="dataInicial"]').value = dataSelecionada;
      form.querySelector('[name="dataFinal"]').value = dataSelecionada;
